# Generated by Django 4.2.23 on 2025-07-16 04:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('F', 'Fruits'), ('V', 'Vegetables'), ('TR', 'Thai Rice'), ('TH', 'Thai Herbs')], max_length=2)),
                ('label', models.CharField(choices=[('N', 'New'), ('B', 'Best Seller'), ('S', 'On Sale')], max_length=2)),
